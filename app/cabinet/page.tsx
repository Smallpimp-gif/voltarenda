    ...
    <div className="mx-auto w-full max-w-content px-gutter py-14">
      ...
      <section className="mt-16">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          ...
          <div
            className={`flex min-h-[200px] flex-col justify-between rounded-lg border border-[var(--line)] bg-[var(--bg-2)] p-8 ${
          ...
          {/* Прогресс выкупа */}
          {v.isBuyout && (
            <div className="flex min-h-[200px] flex-col justify-between rounded-lg border border-[var(--line)] bg-[var(--bg-2)] p-8">
      ...
      <section className="mt-20">
        ...
        <div className="mt-8 rounded-lg border border-[var(--line)] bg-[var(--bg-2)] p-6 sm:p-8">
