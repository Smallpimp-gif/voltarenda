...
export const metadata: Metadata = {
  ...
  description:
    "ВОЛЬТ U2 в аренду для курьеров Санкт‑Петербурга. От 633 ₽/день, выдача за 30 минут. Два АКБ 60+30 Ач, ~120 км на смену. Залог 5 000 ₽ возвратный.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "ВОЛЬТ U2 в аренду. От 633 ₽/день. Два АКБ, ~120 км на смену. Выдача за 30 минут в СПб.",
  },
  twitter: {
