...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "Электровелосипед U2 в аренду в СПб — от 633 ₽/день · Вольтаренда",
    template: "%s · Вольтаренда",
  },
  description:
    "Аренда топовых электровелосипедов U2 для курьеров в Санкт‑Петербурге. 65 км/ч, 2 АКБ, до 120 км на смену. Выдача в день обращения. Цены ниже рынка.",
  keywords: [
  ...
  openGraph: {
    ...
    title: "Электровелосипед U2 в аренду в СПб — от 633 ₽/день",
    description:
      "Топовая модель для курьеров: 65 км/ч, 2 АКБ LiFePO4, до 120 км на смену. Выдача в день обращения, цены ниже рынка СПб.",
  },
  twitter: {
