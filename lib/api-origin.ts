...
// В prod разрешены боевые домены (воркер Cloudflare + будущий voltarenda.ru),
// плюс необязательный APP_ORIGIN из env. В dev — любой http://localhost:*
// (Next.js preview может рандомизировать порт).
//
// Использование:
