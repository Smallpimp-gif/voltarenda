...
export function Slide({
  ...
  return (
    <section
      ...
      data-invest-slide
      data-theme={theme}
      // --acc — акцент для ТЕКСТА/рамок/точек: volt на тёмных слайдах, чёрный
      // на светлых (болотный зелёный убрали — на светлом акцент просто чёрный).
      // Заливки (bg-volt, ценовая полоса) используют volt напрямую.
      style={{ ["--acc"]: theme === "dark" ? "#E5FF00" : "#000000" } as CSSProperties}
