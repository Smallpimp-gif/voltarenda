...
const STEPS = [
  ...
  },
  {
    num: "03",
    title: "Забери велик",
    desc: "Приезжай на точку в Санкт‑Петербурге. Инструктаж, передача ВОЛЬТ U2 — и ты зарабатываешь с первого дня.",
    time: "~15 мин",
  },
];
...
export function HowItWorksSection() {
  ...
  const howToJsonLd = {
    ...
    "@type": "HowTo",
    name: "Как арендовать электровелосипед ВОЛЬТ U2 в Санкт-Петербурге",
